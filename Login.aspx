<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="MilitaryMessage.Login" %>
...
<div class="agileheader">
	<h1>Military Message Passing</h1>
</div>
<!--//header-->
<!--main-->
	...
	<div class="w3layouts-main">
		<h2>Login Now</h2>
			<div class="w3ls-form">
                ...
                <div class="email-w3ls">
                      Select User Type:<asp:DropDownList 
                          ...
                          <asp:ListItem>MSCH</asp:ListItem>
                      </asp:DropDownList>
            ...
            <asp:Label runat="server" Text="" ID="lblMsg"></asp:Label>
				<%--<p>Don't Have an Account ?<a href="HopComsRegister.aspx">Register Now</a></p>--%>
			</div>	
						<div class="clear"></div>
                        <asp:Button runat="server" Text="Login" ID="btnLogin"  ValidationGroup="A"
                        onclick="btnLogin_Click"></asp:Button>
                        <asp:Button runat="server" Text="Home" ID="btnHome" ValidationGroup="A" onclick="btnHome_Click"></asp:Button>
				</form>
			</div>	
